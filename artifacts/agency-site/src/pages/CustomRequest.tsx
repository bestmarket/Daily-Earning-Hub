...
export default function CustomRequest() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: { name: "", email: "", whatsapp: "", businessType: "", description: "", budget: "" },
  });
  ...
  return (
    <>
      <SeoHead
        title="Custom Software Request — DevStudio"
        description="We build ANY business tool for you. Describe what you need, get a quote in 24 hours."
        keywords="custom software, web app development, business tool, quote"
        canonicalPath="/custom-request"
      />
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <FormField control={form.control} name="email" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input placeholder="john@example.com" className="h-12 rounded-xl" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField control={form.control} name="whatsapp" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input placeholder="+1 234 567 8900" className="h-12 rounded-xl" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="businessType" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          <FormControl>
                            <SelectTrigger className="h-12 rounded-xl"><SelectValue placeholder="Select business type" /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                  ...
                  <FormField control={form.control} name="description" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="Describe the tool, the problem it solves, and the key features you need..." className="min-h-[150px] rounded-xl resize-y" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <FormField control={form.control} name="budget" render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="h-12 rounded-xl"><SelectValue placeholder="Select budget range" /></SelectTrigger>
                        </FormControl>
                        <SelectContent>
                  ...
                  <Button type="submit" size="lg" className="w-full h-14 text-lg font-bold rounded-xl mt-4 shadow-xl hover:shadow-primary/25 transition-all" disabled={submitRequest.isPending}>
