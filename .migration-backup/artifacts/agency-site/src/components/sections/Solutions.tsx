...
const solutions = [
  ...
  { Mockup: CustomerPortalMockup, icon: Users, name: "Customer Portals", benefit: "Give customers a self-service hub to track orders, invoices & support.", time: "2–3 weeks", price: "$499", color: "text-purple-600", bg: "bg-purple-50", border: "border-purple-100", topBar: "bg-purple-600" },
  { Mockup: AIMockup, icon: Bot, name: "AI Assistants", benefit: "AI chatbot that handles enquiries, bookings, and support 24/7.", time: "2–3 weeks", price: "$699", color: "text-cyan-600", bg: "bg-cyan-50", border: "border-cyan-100", topBar: "bg-cyan-600" },
  ...
  { Mockup: MembershipMockup, icon: Crown, name: "Membership Platforms", benefit: "Sell memberships with gated content, perks, and renewals.", time: "3–4 weeks", price: "$799", color: "text-yellow-600", bg: "bg-yellow-50", border: "border-yellow-100", topBar: "bg-yellow-500" },
  { Mockup: SubscriptionMockup, icon: CreditCard, name: "Subscription Websites", benefit: "Recurring billing, plan management, and subscriber dashboards.", time: "2–3 weeks", price: "$599", color: "text-violet-600", bg: "bg-violet-50", border: "border-violet-100", topBar: "bg-violet-600" },
  ...
  { Mockup: CRMMockup, icon: BarChart2, name: "CRM Dashboards", benefit: "Track customers, deals, and follow-ups in one clear dashboard.", time: "2–3 weeks", price: "$499", color: "text-blue-600", bg: "bg-blue-50", border: "border-blue-100", topBar: "bg-blue-700" },
  ...
  { Mockup: CourseMockup, icon: BookOpen, name: "Course Platforms", benefit: "Sell online courses with video, quizzes, and certificates.", time: "3–4 weeks", price: "$699", color: "text-indigo-600", bg: "bg-indigo-50", border: "border-indigo-100", topBar: "bg-indigo-600" },
